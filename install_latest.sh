...
REPO="${REPO:-nkguo/simadmin-release}"
...
LPAC_COMPAT_RELEASE_BASE_URL="${LPAC_COMPAT_RELEASE_BASE_URL:-https://github.com/nkguo/simadmin-release/releases/download/lpac}"
...
lpac_url_source() {
  url="$1"
  case "$url" in
    "$LPAC_COMPAT_RELEASE_BASE_URL"/*|https://github.com/nkguo/simadmin-release/releases/download/lpac/*)
      printf '%s\n' "compat"
      ;;
